...
#int, float, str
a = np.array([1,2,3,4,50], dtype=np.complex, ndmin=2)
print(a)
print(a.dtype)

#However, a business analyst will typically just deal with the basics of int, float and strings
a = np.array([1,2,3,4,50], dtype=str, ndmin=2)  #These look like numbers but they are really strings for this example
print(a)
print(a.dtype)
