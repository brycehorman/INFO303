...
if num1 == 0:
    print('Your number is 0. This has a',round(((1/30)*100),2),'chance of occurring.')
if num1 < 0:
    print('Your number is negative. This has a 50% chance of occurring')
else:
    print('Your number is positive, this has a 50% chance of occurring')
    num2 = random.randint(5,10)
    num3 = num1**num2
    print('First number raised to the second number is',num3)
...
names = ('Bryce','Ben','Jack','Dustin')
name = random.choice(names)
print('The randomly selected name is',name)
...
name = random.choice(names)
print('The randomly selected name is',name)
if names.index(name) in (1,3):
    print('I was hoping one of the chosen was Bryce or Jack')
...
if num1 > num2 and num2 > num3:
    print('You entered in descending order.')
else:
    print('You did not enter in descending order.')
...
month = int(input('Enter a month as a number (eg March = 3)'))
if month < 1 or month > 12:
    print('Invalid month')
elif year > 9999 or year < 1:
    print('Invalid year')
elif year % 4 == 0 and year % 100 != 0 and year % 400 == 0 and month == 2:
...
if choice in cars:
    ...
    if choice.lower() in cars:
        print('This value is in the list but is formatted differently.')
    else:
